...
$route['admin/visitors'] = 'admin_products/index';
$route['guard/visitors'] = 'guard_products/index';
$route['guard/visitors/add'] = 'guard_products/add';

$route['admin/visitors/add'] = 'admin_products/add';
